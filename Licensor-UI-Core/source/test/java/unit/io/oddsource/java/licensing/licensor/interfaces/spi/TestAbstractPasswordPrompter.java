...
public class TestAbstractPasswordPrompter
{
    ...
    public void testPromptForValidPassword02()
    {
        ...
        EasyMock.expect(this.prompter.readPassword("Enter pass phrase to encrypt the private key: ")).
            andReturn(password1);
        ...
        char[] password2 = "testPassword01".toCharArray();
        EasyMock.expect(this.prompter.readPassword("Verifying - Reenter pass phrase to encrypt the private key: ")).
            andReturn(password2);
        ...
        char[] password = this.prompter.promptForValidPassword(
            ...
            "Verifying - Reenter pass phrase to encrypt the " +
            "private key: ",
            "The password must be at least seven characters and no" +
    ...
    public void testPromptForValidPassword04()
    {
        ...
        char[] password = this.prompter.promptForValidPassword(
            ...
            "Enter pass phrase to encrypt both keys: ",
            "Verifying - Reenter pass phrase to encrypt both keys: ",
            "The password must be at least eight characters and no" +
    ...
    public void testPromptForValidPassword05()
    {
        ...
        char[] password = this.prompter.promptForValidPassword(
            ...
            "Enter pass phrase to encrypt both keys: ",
            "Verifying - Reenter pass phrase to encrypt both keys: ",
            "The password must be at least zero characters and no " +
            "more than 32 characters long.",
