/*
 * LicenseSecurityManager.java from LicenseManager modified Tuesday, June 28, 2011 11:34:11 CDT (-0500).
 *
...
final class LicenseSecurityManager extends SecurityManager
{
	...
	public void checkMemberAccess(Class<?> reflectionClass, int memberAccessType)
	{
		...
		try
		{
			...
			{
				String packageName = reflectionClass.getPackage().getName();
				if(packageName.startsWith("net.nicholaswilliams.java.licensing") && !reflectionClass.equals(FeatureRestriction.class))
				{
